...
const CarSearch = () => {
  return (
    ...
    <input style={{fontFamily:'Questrial'}} type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-lg" placeholder="Eg. BMW, Lamborgini, Mercedes, Mclaren.. "/>
    </div>
